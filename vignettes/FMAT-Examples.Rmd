...
\* *Note*. The accuracy of the FMAT results is subject to the selected models, their pre-training corpora, and your design of queries, but not to the FMAT methodology.
